...
class ParticipationServiceLeaveChatTest {
  ...
  void leaveChatSuccess() {
    ...
    when(participation.getStatus()).thenReturn(CHAT_JOINED);
  ...
  @Test
  void leaveChatParticipationNotFound() {
    Long participationId = 1L;
  ...
  @Test
  void leaveChat_INVALID_TIME() {
    Long participationId = 1L;
    Long participantId = 1L;
    Long gatheringId = 1L;
    Long hostId = 2L;
    LocalDateTime now = LocalDateTime.now();
    LocalDate recruitmentStartDt = now.toLocalDate().plusDays(1);
    LocalDate recruitmentEndDt = now.toLocalDate().minusDays(2);
    LocalDateTime gatheringDateTime = now.plusDays(3);
  ...
  @Test
  void leaveChat_AUTHORIZATION_ISSUE() {
    Long participationId = 1L;
    Long participantId = 1L;
    Long gatheringId = 1L;
    Long hostId = 2L;
  ...
  @Test
  void leaveChat_PARTICIPATION_CONFLICT() {
    Long participationId = 1L;
    Long participantId = 1L;
    Long gatheringId = 1L;
    Long hostId = 2L;
